...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_get_paginations_questions(self):
    ...
    def test_delete_question(self):
        question = Question(question='test question ?', answer='test to delete question',difficulty=2, category=3)
        question.insert()
    ...
    def test_add_question(self):
        new_question = {
            ...
            'answer': 'test to delete question',
            'difficulty': 2,
            'category': 3
        }
